## fadecandy_ros (noetic) - 0.2.2-1

The packages in the `fadecandy_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic fadecandy_ros` on `Mon, 17 May 2021 07:07:21 -0000`
...
## fadecandy_ros (noetic) - 0.2.1-1

The packages in the `fadecandy_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic fadecandy_ros` on `Tue, 20 Apr 2021 19:34:51 -0000`
...
## fadecandy_ros (melodic) - 0.2.1-1

The packages in the `fadecandy_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic fadecandy_ros` on `Tue, 20 Apr 2021 19:30:24 -0000`
